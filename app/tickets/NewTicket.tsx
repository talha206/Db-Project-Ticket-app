...
export const handleCreateNewTicket = (
    ...
    setRightSectionContent(
      <div className="lg:h-[44rem] xl:h-[44rem] sm:h-auto h-auto xl:px-14 lg:px-10 lg:mb-0 lg:py-10 xrs:px-12 xxs:px-10 pl-6 pr-8 sm:py-7 py-4 font-mono bg-white border-2 border-gray-300 rounded-xl   ">
        <form className="flex flex-col">
          <h1 className="text-base sm:text-lg lg:text-xl ml-2 font-medium  mb-3">Create New Ticket</h1>
          ...
          <div className=" relative lg:mb-9 mb-6 mt-2 w-auto shrink">
            ...
            <label
              htmlFor="ticketType"
              className="absolute left-4 -top-[12px] px-1 bg-white text-[#424247] text-[10px] xrs:text-xs sm:text-sm   peer-focus:text-blue-500  "
            >
              Ticket Type
            </label>
          </div>
          ...
          <div className="relative lg:mb-8">
            <input
              id="hours"
              type="number"
              className="w-full lg:h-10 p-3 pt-4 pb-3 border border-gray-300 rounded text-sm text-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer"
              placeholder="0.00"
            />
            <label
              htmlFor="hours"

...
const Ticket: React.FC = () => {
  ...
  return (
    <div className="w-full h-auto font-mono">
      {/* Main Container */}
      <div className={`2xl:px-20 xl:px-14 md:px-12 sm:px-8 py-10 ${rightSectionContent ? 'lg:pl-10 lg:pr-6' : 'lg:pl-12 lg:pr-8'}`}>
        <div className={`w-full flex flex-col lg:flex-row ${rightSectionContent ? 'gap-x-0' : 'gap-x-4'} items-center lg:items-start justify-between`}>
          ...
          {/* Right Section - Dynamically Render Content */}
          <div
            className={`bg-[#EFEFF0] rounded-xl 2xl:w-[35%] 2xl:h-[44rem] xl:w-[40%] sm:h-[340px] h-72 lg:h-[38rem] xl:h-[40rem] lg:mt-7 sm:ml-0 ml-4 pb-10 flex flex-col ${
              rightSectionContent
                ? 'lg:w-[35%] w-[82%] sm:mb-56 xrs:mb-52 mb-44 lg:mb-10'
                : 'lg:w-[40%] w-[72%]'
            }`}
          >
